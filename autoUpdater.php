...
if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
    $config = array(
        ...
        'api_url' => 'https://api.github.com/repos/Oliwoo/wp-fivem-store', // the GitHub API url of your GitHub repo
        'raw_url' => 'https://raw.github.com/Oliwoo/wp-fivem-store/master', // the GitHub raw url of your GitHub repo
        'github_url' => 'https://github.com/Oliwoo/wp-fivem-store', // the GitHub url of your GitHub repo
        'zip_url' => 'https://github.com/Oliwoo/wp-fivem-store/zipball/master', // the zip url of the GitHub repo
        'sslverify' => true, // whether WP should check the validity of the SSL cert when getting an update, see https://github.com/jkudish/WordPress-GitHub-Plugin-Updater/issues/2 and https://github.com/jkudish/WordPress-GitHub-Plugin-Updater/issues/4 for details
        'requires' => '3.0', // which version of WordPress does your plugin require?
        'tested' => '3.3', // which version of WordPress is your plugin tested up to?
        'readme' => 'README.md', // which file to use as the readme for the version number
        'access_token' => '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', // Access private repositories by authorizing under Plugins > GitHub Updates when this example plugin is installed
    );
